...
class FavoriteRecordInputDialog extends StatefulWidget {
  ...
  @override
  State<FavoriteRecordInputDialog> createState() => _FavoriteRecordInputDialogState();
}

class _FavoriteRecordInputDialogState extends State<FavoriteRecordInputDialog> {
                          ...
                          CustomCircleButton(
                            ...
                            onTap: () async {
                              if (widget.favoriteRecordId == null) {
                                ...
                                if (result!) {
                                  await context.read<MoneyProvider>().deleteFavoriteRecord(
